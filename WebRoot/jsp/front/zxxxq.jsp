...
<jsp:include page="head.jsp" flush="true"/>
    <div class="center">
        <div class="index">
            ...
            <a href="zxx.html">战略性新兴产业</a>
            <a>战略性新兴产业详情</a>
        </div>
        <div class="dtxq-article-container">
            <div class="dtxq-title-container">
                <p class="tongji">
                    <label class="label1 gray" id="dtxq-laiyuan">来源:${zxxxq.nSource }</label>
                    <label class="label2 gray" id="dtxq-date"><fmt:formatDate value="${zxxxq.nPublishTime}" pattern="yyyy-MM-dd"/></label>
                    <label class="label4 gray" id="dtxq-num">浏览量：<span>${zxxxq.nPageView+1 }</span></label>
                ...
                <p class="biaoti" id="dtxq-title">${zxxxq.nTitle }</p>
            </div>
            <div class="dtxq-article-content">
                ...
                <div id="dtxq-content" style="min-height: 200px;position: relative;">${zxxxq.nContent }</div>
            </div>
