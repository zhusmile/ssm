...
<jsp:include page="head.jsp" flush="true"/>
    <div class="center">
        <div class="index">
            ...
            <a href="scz.html">双创周</a>
            <a>双创周详情</a>
        </div>
        <div class="dtxq-article-container">
            <div class="dtxq-title-container">
                <p class="tongji">
                    <label class="label1 gray" id="dtxq-laiyuan">来源:${sczxq.aSource }</label>
                    <label class="label2 gray" id="dtxq-date"><fmt:formatDate value="${sczxq.aPublishTime}" pattern="yyyy-MM-dd"/></label>
                    <label class="label4 gray" id="dtxq-num">浏览量：<span>${sczxq.aPageView+1 }</span></label>
                ...
                <p class="biaoti" id="dtxq-title">${sczxq.aTitle }</p>
            </div>
            <div class="dtxq-article-content">
                ...
                <div id="dtxq-content" style="min-height: 200px;position: relative;">${sczxq.aContent }</div>
            </div>
