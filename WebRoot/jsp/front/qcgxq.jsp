...
<jsp:include page="head.jsp" flush="true"/>
    <div class="center">
        <div class="index">
            ...
            <a href="qcg.html">全面创新改革试验</a>
            <a>全面创新改革试验详情</a>
        </div>
        <div class="dtxq-article-container">
            <div class="dtxq-title-container">
                <p class="tongji">
                    <label class="label1 gray" id="dtxq-laiyuan">来源:${qcgxq.nSource }</label>
                    <label class="label2 gray" id="dtxq-date"><fmt:formatDate value="${qcgxq.nPublishTime}" pattern="yyyy-MM-dd"/></label>
                    <label class="label4 gray" id="dtxq-num">浏览量：<span>${qcgxq.nPageView+1 }</span></label>
                ...
                <p class="biaoti" id="dtxq-title">${qcgxq.nTitle }</p>
            </div>
            <div class="dtxq-article-content">
                ...
                <div id="dtxq-content" style="min-height: 200px;position: relative;">${qcgxq.nContent }</div>
            </div>
