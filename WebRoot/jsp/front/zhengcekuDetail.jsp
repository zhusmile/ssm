...
<jsp:include page="head.jsp" flush="true"/>
    <div class="center">
        <div class="index">
            ...
            <a href="zhengceku.html">政策列表</a>
            <a>政策详情</a>
        </div>
        <div class="dtxq-article-container">
            <div class="dtxq-title-container">
                <p class="tongji">
                    <label class="label1 gray" id="dtxq-laiyuan">来源:${policy.pIssueOrg }</label>
                    <label class="label2 gray" id="dtxq-date"><fmt:formatDate value="${policy.pIssueTime}" pattern="yyyy-MM-dd"/></label>
                    <label class="label4 gray" id="dtxq-num">浏览量：<span>${count }</span></label>
                    <label class="bdsharebuttonbox label3 bdshare-button-style0-16" data-tag="share_1" data-bd-bind="1537171533950">
                        <span>分享到</span>
                        <a class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
                        <a class="bds_tsina" data-cmd="sina" title="分享到新浪微博"></a>
                    </label>
                </p>
                <p class="biaoti" id="dtxq-title">${policy.pTitle }</p>
            </div>
            <div class="dtxq-article-content">
                ...
                <div id="dtxq-content" style="min-height: 200px;position: relative;">${policy.pContent }</div>
            </div>
