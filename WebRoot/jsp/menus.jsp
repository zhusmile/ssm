...
//               html = "<tr id='tr"+this.menuId+"' style='height:24px;line-height:24px;' name='subTr"+menuId+"'>";
              html += "<td></td>";
...
//               html += "<td><a href='###' onclick='openClose("+this.menuId+",this,"+trIndex+")'>展开</a> | <a href='###' onclick='editmenu("+this.menuId+")'>修改</a> | <a href='###' onclick='delmenu("+this.menuId+",false)'>删除</a></td>";
              html += "</tr>";
